...
- В `ОбщийМакет.KFK_Компонента` лежали бинари от РАЗНЫХ коммитов: Windows — `1.9.1-fork.1`,
...
Исправление декодирования AVRO (корень падений на MDM_VariantItems) + ревью памяти/ресурсов компоненты.
